...
def main():
        ...
        print("correcto= ", palabraCorrecta, ListaDePalabrasUsuario)
        intentos = 5
        ...
        # 1 frame cada 1/fps segundos
            ...
            for e in pygame.event.get():
                ...
                if e.type == KEYDOWN:
                    ...
                    #control para que sea una palabra de la longitud deseada
                    if e.key == K_BACKSPACE:
                        palabraUsuario = palabraUsuario[0:len(palabraUsuario)-1]
                    if e.key == K_RETURN:
                        for pat in listaPalabrasDiccionario:
                            if palabraUsuario+"\n" == pat:
                ...
                # efaultFont = pygame.font.Font(pygame.font.get_default_font(), TAMANNO_LETRA)
                # screen.blit(defaultFont.render("correcta", 1, (0, 250, 0)), (190, 570))
